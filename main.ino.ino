...
float start_cart[NUM_AXIS] = {0.0, 0.0, 0.0, 0.0};    //Holds the X Y Z cartesian coordinates of the current position of the tool head
float predicted_cart[NUM_AXIS] = {0.0, 0.0, 0.0, 0.0};           //Holds the predicted X Y Z cartesian coordinates of the tool head at any point in time
float destination_cart[NUM_AXIS] = {0.0, 0.0, 0.0, 0.0};         //Holds the X Y Z cartesian coordinates of the destination position of the tool head

long start_degree[NUM_AXIS] = {0.0, 0.0, 0.0, 0.0};                //Holds the start position for the SCARA MOVE in stepper steps (4th value not yet used)
long move_degree[NUM_AXIS] = {0.0, 0.0, 0.0, 0.0};           //Holds the predicted X Y Z SCARA coordinates of the tool head at any point in time
long destination_degree[NUM_AXIS] = {0.0, 0.0, 0.0, 0.0};               //Holds the finish position for the SCARA MOVE in stepper steps (4th value not yet used)
...
//DRV8825 X_MOTOR(200,X_DIR_PIN,X_STEP_PIN);
...
//---------------------------------------------------------------------------------------------------------------------------------------------        
      case 28: //G28 Home all Axis one at a time
        ...
        WRITE(Y_DIR_PIN, HIGH);             //Direction of travel is towards minus end       
        do
        {
